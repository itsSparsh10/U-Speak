 ...
 */
export function cleanAndValidateAccountId(accountId: string | null | undefined): string {
  if (!accountId) {
 ...
 */
export function extractAccountIdFromUser(user: { corporateAccountId?: string; id?: string }): string {
