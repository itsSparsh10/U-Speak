    ...
    <div className="fixed left-0 top-0 h-full w-64 bg-gradient-to-b from-white via-gray-50/50 to-gray-100/30 border-r border-gray-200/60 backdrop-blur-sm flex flex-col shadow-xl">
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <div className="font-bold text-gray-900 text-sm">TANISH SINGH</div>
                <div className="text-xs text-gray-500 font-medium">CEO</div>
              </div>
            ...
            <div className={cn(
              ...
              <div className="mt-4 pt-4 border-t border-gray-200/60 space-y-3">
                <div className="flex items-center space-x-3 text-sm">
                  ...
                  <span className="text-gray-600">tanish@uspeek.com</span>
                </div>
                <div className="flex items-center space-x-3 text-sm">
      ...
      <div className="p-4 border-t border-gray-200/60 bg-white/50 backdrop-blur-sm">
        <div className="relative group">
          ...
          <button className="relative w-full flex items-center space-x-3 px-4 py-3.5 rounded-xl text-left transition-all duration-300 text-red-600 hover:bg-gradient-to-r hover:from-red-50 hover:to-pink-50 hover:shadow-md group-hover:scale-[1.02]">
